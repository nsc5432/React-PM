                ...
                <ScrollArea className="w-full">
                    <div className="min-w-400">
                        ...
                        <div className="grid grid-cols-[100px_repeat(10,1fr)] border-b bg-gray-100">
                            ...
                            {times.map((time) => (
                                <div key={time} className="border-r last:border-r-0">
                                    <div className="text-center font-bold p-3 border-b bg-gray-50">
                                        {time}
                                    </div>
                                    <div className="grid grid-cols-2">
                                        ...
                                        <div className="text-xs p-2 text-center bg-gray-50 font-semibold">
                                            셀프백드롭
                                        </div>
                                    </div>
                                </div>
                        ...
                        {zones.map((zone, zoneIdx) => (
                            <div
                                key={zoneIdx}
                                className="grid grid-cols-[100px_repeat(10,1fr)] border-b hover:bg-gray-50"
                            >
