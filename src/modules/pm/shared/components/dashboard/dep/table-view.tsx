                ...
                <ScrollArea className="w-full">
                    <div className="min-w-400">
                        ...
                        <div className="grid grid-cols-[100px_repeat(7,1fr)] border-b bg-gray-100">
                            <div className="p-4 font-bold border-r flex items-center justify-center">
                                번호
                            </div>
                            {times.map((time) => (
                                <div key={time} className="border-r last:border-r-0">
                                    <div className="p-4 text-center font-bold border-b bg-gray-200">
                                        {time}
                                    </div>
                                    <div className="grid grid-cols-4 text-xs">
                                        <div className="p-2 border-r border-b text-center font-semibold">
                                            처리 여객
                                        </div>
                                        <div className="p-2 border-r border-b text-center font-semibold">
                                            처리 시간
                        ...
                        {gateNumbers.map((gateNum, gateIdx) => (
                            <div
                                key={gateNum}
                                className="grid grid-cols-[100px_repeat(7,1fr)] border-b"
                            >
                                ...
                                {times.map((time, timeIdx) => {
                                    ...
                                    return (
                                        <div
                                            key={time}
                                            className={`border-r last:border-r-0 ${getCellBgColor(gateIdx, timeIdx)}`}
                                        >
                                            <div className="grid grid-cols-4 text-xs">
                                                ...
                                                <div className="p-2 border-r text-center">
                                                    처리 시간 : {data.processedTime}
                                                </div>
                                                <div className="p-2 border-r text-center">
                                                    대기 여객 :{' '}
                                                    {data.waitPeople.toString().padStart(2, '0')}명
                                                </div>
