          ...
          <div className="space-y-6">
            ...
            {miniChartsData.slice(0, 1).map((chartData, idx) => {
              ...
              const getX = (index: number) =>
                (index / (chartData.data.length - 1)) * (chartWidth - 2 * padding) + padding;
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-center border-2 border-gray-200 px-4 py-2 rounded-xl bg-linear-to-br from-gray-50 to-white shadow-sm">
                      ...
                      <h3 className={`text-2xl font-bold ${currentTheme.accentText}`}>
                        {chartData.r2Score}%
                      </h3>
                    </div>
                  </div>
                      ...
                      <div className="relative">
                        <button
                          onClick={() => {
                            ...
                            setT1CheckinIndex(
                              (prev) => (prev - 1 + checkinOptions.length) % checkinOptions.length,
                            );
                          }}
                          ...
                          >
                            ...
                            <div className="p-5 text-center bg-white">
                              <div className="text-gray-600 font-semibold text-sm mb-1">
                                {checkinOptions[t1CheckinIndex].name}
                              </div>
                              <div className="text-3xl font-bold text-red-600 mb-2">
                                {checkinOptions[t1CheckinIndex].code}
                              </div>
                              <div className="text-xs text-gray-600 mb-3">
                                {checkinOptions[t1CheckinIndex].stats}
                              </div>
                                ...
                                {checkinOptions[t1CheckinIndex].blocks.map((b, bIdx) => (
                                  <div
                                    ...
                                    className={`w-5 h-5 text-white text-[10px] flex items-center justify-center rounded font-bold shadow-sm ${
                                      checkinOptions[t1CheckinIndex].blockColors[bIdx] ===
                                      'darkgreen'
                                        ? 'bg-green-800'
                                        : checkinOptions[t1CheckinIndex].blockColors[bIdx] ===
                                            'green'
                      ...
                      <div className="relative">
                        <button
                          onClick={() => {
                            ...
                            setT1DepartureIndex(
                              (prev) =>
                                (prev - 1 + departureOptions.length) % departureOptions.length,
                            );
                          }}
                          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1.5 z-20 w-6 h-6 bg-white rounded-full shadow-md border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-all"
                        >
                        ...
                        <div className="overflow-hidden">
                          ...
                          >
                            ...
                            <div className="p-5 text-center bg-white">
                              <div className="text-gray-600 font-semibold text-sm mb-1">
                                {departureOptions[t1DepartureIndex].name}
                              </div>
                              <div className="text-3xl font-bold text-red-600 mb-2">
                                {departureOptions[t1DepartureIndex].code}
                              </div>
                              <div className="text-xs text-gray-600 mb-3">
                                {departureOptions[t1DepartureIndex].stats}
                              </div>
                              <span className="inline-block bg-linear-to-r from-red-500 to-red-600 text-white px-4 py-1.5 rounded-full text-xs font-bold shadow-md">
                              ...
                              <div className="flex justify-center gap-1 flex-wrap">
                                {departureOptions[t1DepartureIndex].blocks.map((b, bIdx) => (
                                  <div
                                    key={bIdx}
                                    className={`w-5 h-5 text-white text-[10px] flex items-center justify-center rounded font-bold shadow-sm ${
                                      departureOptions[t1DepartureIndex].blockColors[bIdx] ===
                                      'darkgreen'
                                        ? 'bg-green-800'
                                        : departureOptions[t1DepartureIndex].blockColors[bIdx] ===
                                            'green'
                  ...
                  <div className="grid grid-cols-[1fr_2fr] gap-4 mb-6">
                    ...
                    <div className="space-y-4">
                      <div className="bg-linear-to-br from-blue-50 to-blue-100 p-6 rounded-xl text-center border-2 border-blue-200 shadow-sm">
                        ...
                        <div className="text-xs text-gray-500">
                          지난주 대비{' '}
                          <span className="text-red-600 font-semibold">{terminal.flightDiff}</span>
                        </div>
                      </div>
                      <div className="bg-linear-to-br from-green-50 to-green-100 p-6 rounded-xl text-center border-2 border-green-200 shadow-sm">
                        <div className="flex items-center justify-center gap-2 mb-3">
                            ...
                            <div className="flex justify-center gap-1 flex-wrap">
                              {checkinOptions[t2CheckinIndex].blocks.map((b, bIdx) => (
                                <div
                                  key={bIdx}
                                  className={`w-5 h-5 text-white text-[10px] flex items-center justify-center rounded font-bold shadow-sm ${
                                    checkinOptions[t2CheckinIndex].blockColors[bIdx] === 'darkgreen'
                                      ? 'bg-green-800'
                                      : checkinOptions[t2CheckinIndex].blockColors[bIdx] === 'green'
                                        ? 'bg-green-600'
                                        : checkinOptions[t2CheckinIndex].blockColors[bIdx] === 'red'
                                          ? 'bg-red-600'
                                          : 'bg-orange-600'
                                  }`}
                                >
                    ...
                    <div className="relative">
                      ...
                      <div className="overflow-hidden">
                        ...
                        >
                          ...
                          <div className="p-5 text-center bg-white">
                            <div className="text-gray-600 font-semibold text-sm mb-1">
                              {departureOptions[t2DepartureIndex].name}
                            </div>
                            <div className="text-3xl font-bold text-red-600 mb-2">
                              {departureOptions[t2DepartureIndex].code}
                            </div>
                            <div className="text-xs text-gray-600 mb-3">
                              {departureOptions[t2DepartureIndex].stats}
                            </div>
                            <span className="inline-block bg-linear-to-r from-red-500 to-red-600 text-white px-4 py-1.5 rounded-full text-xs font-bold shadow-md">
                            ...
                            <div className="flex justify-center gap-1 flex-wrap">
                              {departureOptions[t2DepartureIndex].blocks.map((b, bIdx) => (
                                <div
                                  key={bIdx}
                                  className={`w-5 h-5 text-white text-[10px] flex items-center justify-center rounded font-bold shadow-sm ${
                                    departureOptions[t2DepartureIndex].blockColors[bIdx] ===
                                    'darkgreen'
                                      ? 'bg-green-800'
                                      : departureOptions[t2DepartureIndex].blockColors[bIdx] ===
                                          'green'
