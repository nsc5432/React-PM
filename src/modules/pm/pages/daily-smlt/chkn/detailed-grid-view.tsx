                ...
                <ScrollArea className="w-full">
                    <div className="min-w-350">
                        ...
                        {counters.map((counter, idx) => (
                            <div
                                key={idx}
                                className="grid grid-cols-[100px_repeat(7,1fr)] border-b hover:bg-muted/10"
                            >
                                    ...
                                    return (
                                        <div key={time} className="border-r last:border-r-0">
                                            <div className="grid grid-cols-2 h-full">
                                                <div
                                                    className={`p-2 border-r text-xs ${isHighlighted ? 'bg-warning/20' : ''}`}
                                                >
                                                ...
                                                <div
                                                    className={`p-2 text-xs ${isHighlighted ? 'bg-warning/20' : ''}`}
                                                >
                                                    <div className="space-y-0.5 text-[10px] leading-tight">
                                                        <div>처리 여객 : 00명</div>
                                                        <div>처리 시간 : 000초</div>
