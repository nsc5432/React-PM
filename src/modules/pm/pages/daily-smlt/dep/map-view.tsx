        ...
        <div className="relative">
          <div
            className={`w-32 h-72 rounded-lg shadow-xl flex flex-col items-center cursor-pointer transition-all hover:scale-105 border-2 ${
              gate.status === 'busy' ? 'bg-white border-gray-300' : 'bg-white border-gray-300'
            }`}
          >
            {/* Header */}
            ...
            <div className="mt-3 mb-2">
              <div
                className={`px-4 py-1 rounded text-xs font-bold ${
                  gate.status === 'busy' ? 'bg-red-500 text-white' : 'bg-cyan-400 text-white'
                }`}
              >
        ...
        <Card className="p-8">
          ...
          <div className="relative bg-gray-50 p-8 rounded-lg border-2 border-gray-200 min-h-150">
            ...
            <div className="absolute bottom-2 left-8 right-8 grid grid-cols-14 gap-1">
              {['N', 'M', 'L', 'K', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'C', 'B', 'A'].map(
                (label) => {
