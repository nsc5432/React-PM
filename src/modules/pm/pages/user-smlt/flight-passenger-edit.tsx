          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="h-40 bg-gray-50 flex items-end justify-around px-4 pb-4">
                {[40, 60, 80, 100, 120, 200, 200, 200, 100, 100, 60, 40].map((height, idx) => (
                  <div
                    key={idx}
              ...
              <div className="mt-4 text-center">
                <span className="text-sm">
                  *운항 <span className="text-blue-600 font-medium">1,234,567편</span> 전체(누적)
                </span>
                <br />
                <span className="text-xs text-gray-600">
                  직전 주 평균일(24-10-11) 대비 <span className="text-red-500">+ 2편</span>
                </span>
              </div>
            </div>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="mt-4 text-center">
                <span className="text-sm">
                  *여객 <span className="text-blue-600 font-medium">1,234,567명</span> 전체(누적)
                </span>
                <br />
                <span className="text-xs text-gray-600">
                  직전 주 평균일(24-10-11) 대비 <span className="text-red-500">+268명</span>
                </span>
              </div>
            </div>
          </div>
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={idx}>
                          <td className="border px-4 py-2 text-center">{row.start}</td>
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={idx}>
                          <td className="border px-4 py-2 text-center">{row.start}</td>
                          <td className="border px-4 py-2 text-center">{row.end}</td>
