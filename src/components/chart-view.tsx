          ...
          <ResponsiveContainer width="100%" height={450}>
            ...
            >
              ...
              <Line
                ...
                activeDot={{ r: 8, fill: colors.secondary, stroke: "#fff", strokeWidth: 3 }}
                animationDuration={1500}
                animationBegin={900}
              />
              <Line
                ...
                activeDot={{ r: 8, fill: colors.tertiary, stroke: "#fff", strokeWidth: 3 }}
                animationDuration={1500}
                animationBegin={1200}
              />
              <Line
                ...
                strokeWidth={2.5}
                name="대기인원(전재)"
                dot={{ r: 4, fill: colors.quaternary, stroke: "#fff", strokeWidth: 2 }}
                strokeDasharray="8 4"
                activeDot={{ r: 7, fill: colors.quaternary, stroke: "#fff", strokeWidth: 2 }}
                animationDuration={1500}
                animationBegin={1500}
              />
            </ComposedChart>
